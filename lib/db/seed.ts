...
const INFO_PAGES_DATA = [
  ...
  },
  {
    ...
    category: "stress" as const,
    imageUrl: "https://images.unsplash.com/photo-1474631245212-32dc3c8310c6?w=800&q=80",
  ...
  },
  {
    ...
    category: "meditation" as const,
    imageUrl: "https://images.unsplash.com/photo-1447452001602-7090c7ab2db3?w=800&q=80",
  ...
  },
  {
    ...
    category: "meditation" as const,
    imageUrl: "https://images.unsplash.com/photo-1531353826977-0941b4779a1c?w=800&q=80",
...
const BREATHING_EXERCISES_DATA = [
  { code: '748', name: '7-4-8 Relaxation', description: "Idéal pour l'endormissement et la gestion de l'anxiété. L'expiration longue active le système parasympathique.", inspire: 7, hold: 4, expire: 8, category: 'basic' as const, benefit: "Réduit l'anxiété en 4 cycles", color: 'from-green-400 to-green-600', displayOrder: 1 },
  { code: '55', name: '5-5 Cohérence cardiaque', description: "L'exercice de référence. 6 respirations par minute pendant 5 minutes = 4 à 6h de réduction du cortisol.", inspire: 5, hold: 0, expire: 5, category: 'basic' as const, benefit: 'Équilibre le système nerveux', color: 'from-green-500 to-emerald-600', displayOrder: 2 },
  { code: '46', name: '4-6 Apaisement rapide', description: "Expiration plus longue que l'inspiration pour un effet calmant immédiat. Parfait en situation de stress.", inspire: 4, hold: 0, expire: 6, category: 'basic' as const, benefit: 'Calme en 2 minutes', color: 'from-emerald-400 to-green-600', displayOrder: 3 },
  { code: '478', name: '4-7-8 Profonde', description: 'Technique du Dr. Andrew Weil. La rétention longue augmente le CO2 sanguin, calmant puissamment le système nerveux.', inspire: 4, hold: 7, expire: 8, category: 'advanced' as const, benefit: 'Endormissement rapide', color: 'from-green-600 to-green-800', displayOrder: 4 },
  { code: '363', name: '3-6-3 Équilibre', description: "Inspiration courte, expiration double. Idéal pour les débutants qui trouvent les exercices longs difficiles.", inspire: 3, hold: 6, expire: 3, category: 'advanced' as const, benefit: 'Accessible aux débutants', color: 'from-green-500 to-green-700', displayOrder: 5 },
  { code: '5510', name: '5-5-10 Relaxation profonde', description: 'Expiration très longue pour une relaxation maximale. Recommandé pour les praticiens expérimentés.', inspire: 5, hold: 5, expire: 10, category: 'advanced' as const, benefit: 'Relaxation maximale', color: 'from-green-700 to-green-900', displayOrder: 6 },
];
...
export async function seed() {
  ...
  try {
    ...
    if (existingPages.length === 0) {
      ...
      // Update existing pages with images if missing
      const IMAGE_MAP: Record<string, string> = {};
      for (const p of INFO_PAGES_DATA) {
        if (p.imageUrl) IMAGE_MAP[p.slug] = p.imageUrl;
      }
    ...
    if (existingExercises.length === 0) {
      ...
      console.log(`✅ ${BREATHING_EXERCISES_DATA.length} exercices de respiration`);
    } else {
      console.log("⏭️  Exercices de respiration déjà existants");
    }
